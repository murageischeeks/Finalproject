    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('profile.update') }}">
            ...
            <div class="mb-4">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
